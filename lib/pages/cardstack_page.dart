                      ...
                      itemBuilder: (context, index) {
                        if (pageCardStack.cards[index] is QuizCard) {
                          if (reordering) {
                            ...
                            if ((pageCardStack.cards[index] as QuizCard)
                                .questionText
                                .isNotEmpty) {
                              return Container(
                                key: Key('$index'),
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Visibility(
                                        visible: (pageCardStack.cards[index]
                                                    as QuizCard)
                                                .answers
                                                .length <
                                            4,
