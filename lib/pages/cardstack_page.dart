  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      onPopInvoked: (bool didPop) {
        appData.addOrOverwritePrivateCardStackInFirestore(pageCardStack);
        // print("miv mik rustam durak miv miv miv miv miv miv miv miv miv miv miv miv miv miv pik pik pik pik pik pik pik pik pik pik pik pik pik pik pik pik ");
      },
      child: Consumer(
